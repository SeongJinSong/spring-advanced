package spring.proxy.config.v2_dynamicproxy;

import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;
import spring.proxy.app.v1.*;
import spring.proxy.config.v2_dynamicproxy.handler.LogTraceBasicHandler;
import spring.proxy.config.v2_dynamicproxy.handler.LogTraceFilterHandler;
